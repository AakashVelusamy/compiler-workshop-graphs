...
def extract_cfg(input_file_path, output_file_path):
    ...
    for func in data.get("functions", []):
        ...
        # Ensure that "b1" connects to "header"
        if "header" in nodes:
            edges.append(("b1", "header"))
...
# Example usage
input_file_path = r'C:\Users\Aakash V\Documents\GitHub\compiler-workshop-graphs\day1\graph_tests\test3.json'
output_file_path = r'C:\Users\Aakash V\Documents\GitHub\compiler-workshop-graphs\day1\graph_tests\Output\test3.json.out'
